...
ref.q = 1.5; % [L/s] reference input volumetric flow rate
...
%%% Choose this for Direct Collocation:
...
% (note that for Multiple Shooting vs. Single Shooting, go to "N_shooting_intervals")
